...
export const fetchEmployeeData = async (employeeId) => {
    try {
        ...
        const employeeResponse = await fetch(`https://b3e0-180-150-7-92.ngrok-free.app/people/${employeeId}`);
        ...
        const departmentResponse = await fetch(`https://b3e0-180-150-7-92.ngrok-free.app/departments`);
