...
function AddUpdateScreen({ route, navigation }) {
    ...
    useEffect(() => {
        if (isEditing) {
            console.log(`Fetching URL: https://251f-180-150-7-92.ngrok-free.app/people/${staffId}`);
            // Fetch staff member's data for editing
            fetch(`https://251f-180-150-7-92.ngrok-free.app/people/${staffId}`)
    ...
    const handleSave = () => {
        ...
        const url = `https://251f-180-150-7-92.ngrok-free.app/people${isEditing ? `/${staffId}` : ''}`;
